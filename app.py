...
# --- FUNZIONE RESET INGRESSO (FIX DEFINITIVO ERRORI API) ---
def reset_ingresso():
    st.session_state["ing_targa"] = ""
    st.session_state["marca_input"] = ""
    st.session_state["modello_input"] = ""
    st.session_state["colore_input"] = ""
